...
// // Consistent Glow Component (Matching Signup's Indigo/Blue theme)
// const LoginBackgroundGlow = () => (
//   <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
//     <div
//       className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-25"
...
//   return (
//     <div className="min-h-screen w-full bg-[#0a0a0a] text-white flex flex-col md:flex-row font-sans">
//       {/* LEFT SECTION: Marketing/Info (Mirroring Signup) */}
//       <div className="relative hidden md:flex w-1/2 flex-col p-12 overflow-hidden border-r border-white/5 bg-[#0a0a0a]">
//         {/* Grid Background */}
//         <div
//           className="absolute inset-0 opacity-10 z-0"
//           style={{
...
//         {/* CENTERED IMAGE CARD (Same 4:3 Aspect Ratio) */}
//         <div className="flex-1 flex items-center justify-center relative z-10 px-12">
//           <div className="max-w-2xl w-full p-2 rounded-2xl bg-[#111111]/80 border border-white/10 backdrop-blur-md overflow-hidden shadow-[0_0_50px_-12px_rgba(99,102,241,0.2)]">
//             <div className="relative aspect-4/3 w-full rounded-xl overflow-hidden shadow-2xl border border-white/5">
//               <Image
//                 src={mmm}
...
//               />
//               <div className="absolute inset-0 bg-linear-to-t from-[#0a0a0a] via-transparent to-transparent z-10 opacity-80"></div>
//             </div>
...
//                 Continue your journey toward mastering modern stacks.
//               </p>
//             </div>
//           </div>
//         </div>
...
//       <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-8 py-12 relative bg-[#0a0a0a]">
...
//                   <Link href="/forgot-password text-indigo-400 hover:text-indigo-300 transition-colors font-medium">
//                     Forgot password?
//                   </Link>
//                 </div>
//               </div>
...
//               <Button
//                 type="submit"
//                 className="h-12 w-full flex items-center justify-center gap-2 bg-[#857938] hover:bg-[#857938] text-white font-bold transition-all hover:scale-[1.01] active:scale-[0.98] shadow-lg shadow-indigo-500/20"
//                 disabled={loading || isPending}
//               >
//                 {loading ? (
//                   <>
...
//             Identity verification by SyntaxPath Auth
//           </p>
//         </div>
//       </div>
//     </div>
