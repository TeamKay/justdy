...
//   courseLevels,
//   CourseSchemaType,
//   courseSchema, // Ensure courseSchema is imported correctly from your zod path
// } from "@/lib/zodSchemas";
...
//   // FIXED: Changed generic type declarations and resolver mappings to use course schemas
...
//       }
//     } catch {
//       toast.error("Something went wrong compiling server records.");
//     } finally {
...
//   return (
//     <Form {...form}>
//       <form className="w-full px-4 md:px-8 pb-20 pt-5">
//         {/* --- HEADER SECTION --- */}
