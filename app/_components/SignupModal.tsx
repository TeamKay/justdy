...
export function SignupModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="p-0 border-none bg-transparent max-w-md w-full shadow-2xl overflow-hidden sm:rounded-2xl max-h-[95vh] overflow-y-auto">
        <div className="w-full p-1.5 rounded-2xl bg-[#111111]/90 border border-white/10 backdrop-blur-xl relative z-10 shadow-[0_0_50px_-12px_rgba(99,102,241,0.25)] text-white">
          <div className="bg-[#0a0a0a] rounded-xl border border-white/5 py-6 px-5 sm:px-8 flex flex-col justify-between">
            {/* Header */}
            <DialogHeader className="flex flex-col items-center text-center space-y-1 mb-4">
            ...
            <Form {...form}>
              ...
              >
                ...
                <div className="space-y-1 mb-3">
                  <FormLabel className="text-[11px] text-zinc-400 font-medium">
                    I am joining as a
                  </FormLabel>
                  <div className="grid grid-cols-2 gap-2 pt-1">
                    ...
                    <button
                      ...
                      className={`relative flex flex-col items-start p-2.5 rounded-lg border text-left transition-all duration-200 cursor-pointer ${
                    ...
                    >
                      {selectedRole === "Learner" && (
                        <CheckCircle2 className="absolute top-2 right-2 w-3.5 h-3.5 text-indigo-400" />
                      )}
                      <div
                        className={`p-1 rounded-md mb-1.5 ${
                          selectedRole === "Learner"
                    ...
                    <FormItem>
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          className="h-10 bg-zinc-900/50 border-white/10 text-white text-xs placeholder:text-zinc-500 focus:ring-indigo-500/30"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                ...
                <Button
                  type="submit"
                  disabled={isPending}
                  className="h-10 w-full mt-2 flex items-center justify-center gap-2 bg-[#857938] hover:bg-blue-500 text-white font-semibold text-xs transition-all shadow-md shadow-black/40 cursor-pointer"
                >
                  {isPending ? (
                    <>
                      <Loader className="animate-spin" size={15} /> Creating
                      Account...
                    </>
                  ) : (
                    <>
                      <UserPlus size={15} /> Continue as{" "}
