...
export function MathSectionAlternative() {
  const features = [
    {
      title: "Expert Tutors",
      desc: "Learn from top-tier educators dedicated to making complex equations clear.",
      icon: <GraduationCap className="h-5 w-5 text-primary" />,
    },
    {
      title: "Interactive Lessons",
      desc: "Engage with dynamic visual proofs, practical tools, and active problem-solving.",
      icon: <Sparkles className="h-5 w-5 text-primary" />,
    },
    {
      title: "Exam Preparation",
      desc: "Targeted strategies designed to build speed, precision, and testing confidence.",
      icon: <Target className="h-5 w-5 text-primary" />,
    },
    {
      title: "Personalized Learning",
      desc: "Custom-tailored curriculums that shift dynamically to focus on your weak points.",
      ...
      <div className="container relative mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="max-w-6xl px-30 mb-20 text-center">
          ...
          <p className="mt-6 text-xl text-muted-foreground leading-relaxed">
            Our mathematics program equips learners with the confidence,
            critical thinking, and analytical skills needed to excel in school
            and beyond.
          </p>
        </div>
            ...
            <div className="relative z-10 overflow-hidden rounded-md border bg-card aspect-4/5 shadow-xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between gap-4 rounded-md border border-white/10 bg-black/40 p-4 backdrop-blur-md">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-neutral-300">Active Learners</p>
                </div>
              </div>
            </div>
