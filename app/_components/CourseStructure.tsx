...
//   // Helper function to map data chapters into item state format
...
//   // 2. Track previous chapters prop
//   const [prevChapters, setPrevChapters] = useState(data.chapter);

//   // 3. Sync state during render pass if props change (No useEffect needed)
...
//                                       <Link
//                                         href={`/dashboard/educator/products/${data.id}/${item.id}/${lesson.id}`}
//                                       >
//                                         {lesson.title}
//                                       </Link>
//                                     </div>
...
//   reorderChapters,
//   reorderLessons,
// } from "../actions/educator-edit-course";
...
//                                       <FileText className="size-4" />
//                                       <Link
//                                         href={`/educator/courses/${data.id}/${item.id}/${lesson.id}`}
//                                       >
//                                         {lesson.title}
//                                       </Link>
//                                     </div>
