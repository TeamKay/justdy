...
export default function ResetPasswordClient() {
  ...
  const callbackUrl = useMemo(() => {
     ...
     *
     * This prevents an attacker from supplying something like:
     *
     * https://malicious-site.com
     *
     * as the callback destination.
     */
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // --------------------------------------------------------
      //
      // resetPassword() does not automatically sign the
      // customer in because autoSignInAfterVerification
      // is disabled in your Better Auth configuration.
      //
      // Therefore:
      //
      ...
      const loginUrl = `/?login=true&callbackUrl=${encodeURIComponent(
        callbackUrl,
      )}`;
