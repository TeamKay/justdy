...
// ✅ FIXED: VideoPlayer is now declared OUTSIDE of the render function
function VideoPlayer({
  ...
  const videoUrl = videoKey ? `https://utfs.io/f/${videoKey}` : undefined;
  const thumbnailUrl = thumbnailKey
    ? `https://utfs.io/f/${thumbnailKey}`
    : undefined;
