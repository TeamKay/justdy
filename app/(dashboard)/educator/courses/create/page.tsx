...
export default function CourseCreationPage() {
  ...
  // ✅ FIX 1: Single unified state tracking your local File object
  ...
  async function handleProcess(
    ...
    try {
      ...
      // ✅ FIX 2: Check against 'selectedImage' instead of 'thumbnailFile'
      if (selectedImage) {
        ...
        // Capture URL generated by Uploadthing
      ...
      if (result.status === "success") {
        ...
        form.reset();
        setSelectedImage(null); // Clear active file pointer
            ...
            <Card className="shadow-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <FileText className="size-5 text-primary" /> Course Content
                </CardTitle>
              </CardHeader>
