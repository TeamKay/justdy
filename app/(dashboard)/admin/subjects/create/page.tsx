...
import { createSubject } from "@/app/actions/admin-subjects";
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      {/* If your RichTextEditor natively expects RHF fields, keep it. 
                          Otherwise standard `<textarea className="border w-full p-3 rounded-md" rows={6} {...field} />` works perfectly. */}
