...
//                 <div className="absolute inset-0 pointer-events-none bg-linear-to-tr from-emerald-500/5 via-transparent to-white/5 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
//               </Card>
//             </Link>
//           ))}
//         </div>
